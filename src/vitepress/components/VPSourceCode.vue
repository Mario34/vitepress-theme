...
<template>
  <div class="example-source-wrapper">
    <div class="operation">
      <VTIconCode class="vt-icon" @click="state.isOpen = !state.isOpen" />
    </div>
    <div
      ...
      :style="foldSty"
    >
      <div ref="codeRef" class="example-source language-vue" v-html="source" />
    </div>
  </div>
</template>
